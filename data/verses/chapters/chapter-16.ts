export const chapter16 = [
  ...
  },
  {
    ...
    meaning:
      "అహంకారము, బలము, గర్వము, కామము, మరియు కోపముచే కళ్ళుమూసుకుపోయి, ఈ ఆసురీ ప్రవృత్తి కలవారు, తమ దేహములో మరియు ఇతరుల దేహములో కూడా ఉన్న నన్ను దుర్భాషలాడుతూ/ద్వేషిస్తూ ఉంటారు.",
    commentary:
