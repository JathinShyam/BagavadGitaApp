export const chapter6 = [
  ...
  },
  {
    ...
    meaning:
      "నీ మనస్సు యొక్క శక్తిచే నిన్ను నీవు ఉద్ధరించుకోనుము, అంతేకాని పతనమైపోవద్దు. ఎందుకంటే మనస్సే మన మిత్రుడు మరియు మనస్సే మన శత్రువు అవ్వచ్చు.",
    word_meanings: [
  ...
  },
  {
    ...
    meaning:
      "అందరి యోగులలో కెల్లా, ఎవరి మనస్సు ఎల్లప్పుడూ నాయందే నిమగ్నమై ఉంటుంది, ఎవరు నా యందు ధృఢ విశ్వాసంతో భక్తితో ఉంటారో, వారిని అత్యున్నతమైన వారిగా పరిగణిస్తాను.",
    word_meanings: [
