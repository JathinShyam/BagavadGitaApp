export const chapter12 = [
  ...
  },
  {
    ...
    meaning:
      "ఒకవేళ నీవు మనస్సును నా యందే నిశ్చలముగా లగ్నం చేయలేకపోతే, ఓ అర్జునా, మనస్సును నిరంతరం ప్రాపంచిక విషయాల నుండి నిగ్రహిస్తూ, నన్ను భక్తితో స్మరించటానికి అభ్యాసము చేయుము.",
    commentary:
  ...
  },
  {
    ...
    meaning:
      "ఎవ్వరినీ బాధ పెట్టని వాడు, మరియు ఇతరుల చేత హాని పొందినా ఆయన ఉద్వేగం చెందకుండా, సుఖాలు మరియు కష్టాలు ఏకదృశ్యం గా ఎదుర్కొని, భయాల పట్ల విముక్తుడై, ఆందోళన లేకుండా ఉన్న వ్యక్తి నా ప్రియుడు.",
    commentary:
  ...
  },
  {
    ...
    meaning:
      "ప్రాపంచిక లాభాల పట్ల అనాసక్తతతో ఉండి, శరీరాంతరాలతో పవిత్రంగా, దక్షతతో, ఉదాసీనంగా, కలతలు లేకుండా, మరియు అన్ని కార్యాలపై స్వార్థచింతన లేకుండా ఉన్న నా భక్తులు నాకు చాలా ప్రియమైనవారు.",
    commentary:
