export const chapter16 = [
  ...
  },
  {
    ...
    verse_number: "23",
    teluguSloka:
      "యః శాస్త్రవిధిముత్సృజ్య వర్తతే కామకారతః |\nన స Siddిం అవాప్నోతి న సుఖం న పరాం గతిమ్ ।। 23 ।。",
    word_meanings: [
    ...
    meaning:
      "BG 16.23: ఎవరైతే శాస్త్రములో చెప్పబడిన ఆదేశములను కాదని, కామ ప్రేరితులై ప్రవర్తిస్తారో, వారు పరిపూర్ణ Siddి ని కానీ, సుఖాన్ని కానీ, చివరకి జీవిత పరమ లక్ష్యమును కానీ సాధించలేరు.",
    commentary:
